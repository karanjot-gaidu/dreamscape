...
def keep_warm():
    ...
    generate_url = "https://karanjot-gaidu--sd-demo-modal-generate.modal.run"

    # First check endpoint
    health_respone = requests.get(health_url)
    print(f"Health check at: {health_respone.json()['timestamp']}")
